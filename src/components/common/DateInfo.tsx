...
export default function DateInfo() {
  ...
  const calculateDateInfo = () => {
    ...
    return `今天是 ${year} 年·第 ${dayOfYear} 天 · 今年过了 ${yearPercentage.toFixed(7)}% 今天过了 ${dayPercentage.toFixed(7)}%，时光似箭，日月如梭...`;
  };
  ...
  return (
    <div className="text-xl text-light-text-secondary dark:text-dark-text-secondary whitespace-pre-line max-w-6xl mx-auto">
      {dateInfo}
    </div>
  );
}
