...
import { projects, type Project } from '@site/data/projects'
import Marquee from '@site/src/components/magicui/marquee'
import { SectionNoMore } from '../SectionNoMore'
...
export default function ProjectSection() {
  return (
    <SectionNoMore
      title={<Translate id="homepage.project.title">参与的开源项目</Translate>}
